...
import 'data/dreamBodyShape.dart';
class DreamBodyShapeScreen extends GetView<OnboardingController>{
  const DreamBodyShapeScreen({super.key});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Dream Body Shape"),
            ...
            children: [
                        ...
                        return Padding(
                          ...
                          child: SelectionBox(
                            ...
                            isSelected: controller
                                .onboarding.value.dreamBodyShape ==
                                bodyType.id,
                            onTap: () =>
                                controller.submitDreamBodyShape(bodyType.id),
                          ),
                        );
                      },
                    ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    // You might want a separate submit button logic here
                    // For now, selection navigates.
                  },

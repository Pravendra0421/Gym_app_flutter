...
class CrunchesScreen extends GetView<OnboardingController>{
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
        ...
        title: "How many crunches can you do?",
        ...
        selectedOptionId: controller.onboarding.value.crunches_reps,
        onOptionSelected: (selectedId) {
          controller.submitcrunches(selectedId); // The function to call on tap
        },
      ),
    );
  }
